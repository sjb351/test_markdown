...
![Raspberry Pi Shoestring install flow](docs/assets/raspberry_pi_install_flow.png)
...
![Raspberry Pi command overview](docs/assets/raspberry_pi_commands.png)
...
![Raspberry Pi troubleshooting map](docs/assets/raspberry_pi_troubleshooting.png)
